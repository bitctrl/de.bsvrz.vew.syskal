    ...
    MutableSetChangeListener, BenachrichtigeListener
{
  ...
  /**
   * Hilfsmethode, die formal nicht zur Systemkalenderbibliothek gehÃÂ¶rt, aber fÃÂ¼r deren Test notwendig ist. Hierbei
   * werden die EintrÃÂ¤ge vom DaV gelesen und ausgewertet.
   * 
   * @return Liste der EintrÃÂ¤ge als HashMap
   */
