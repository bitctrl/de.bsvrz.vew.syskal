...
/**
 * Schnittstelle zum Erzeugen von SystemKalenderEintrÃÂ¤gen. Bietet einen einheitlichen Zugriff auf alle Typen von
 * SystemKalendereintrÃÂ¤gen *
 * 
...
public interface SystemkalenderEintrag
{
   ...
   * 
   * @param jahr
   *          das Jahr fÃÂ¼r welches die Wechsel berechnet werden
   ...
   * @param jahr
   *          das Jahr fÃÂ¼r welches die Wechsel berechnet werden
   * @return SortedMap<Long, Long> zeitl. sortierte Liste der GÃÂ¼ltigkeiten
   */
  public SortedMap<Long, Long> berechneIntervall(Long von, Long bis, int jahr);

  
  /**
   * Berechnet die Zeitstempel der Zustandswechsel fÃÂ¼r das Versenden des Ereigniszustands
   * 
   * @param von
   *          Anfangszeitpunkt
   * @param bis
   ...
   * @param bis
   *          Endezeitpunkt der Berechnung
   * @return Liste der GÃÂ¼ltigkeiten
   */
