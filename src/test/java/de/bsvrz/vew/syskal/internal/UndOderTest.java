...
public class UndOderTest {
    ...
    public static void init() {
        ...
        eintragsProvider.parseAndAdd(eintragsProvider, "MDay",
                "ODER{Montag, Mittwoch}");
        eintragsProvider.parseAndAdd(eintragsProvider, "SDay",
                "ODER{Samstag, Sonntag}");
        eintragsProvider.parseAndAdd(eintragsProvider, "AlleTage","UND{DDay, MDay, SDay}");
    ...
    public void pruefeGueltigkeit() {
        ...
        assertFalse(eintrag.getZeitlicheGueltigkeit(LocalDateTime.of(2018,2,22,4,0)).isZeitlichGueltig());
        assertFalse(eintrag.getZeitlicheGueltigkeit(LocalDateTime.of(2018,2,26,4,0)).isZeitlichGueltig());
    }
