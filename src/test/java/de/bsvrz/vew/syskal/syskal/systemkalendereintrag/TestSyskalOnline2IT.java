...
public class TestSyskalOnline2IT implements StandardApplication {
     ...
     * Die Liste der Konfigurationsbereiche wird durch Aufspaltung des
     * übergebenen Strings erstellt und die speziellen Startparameter werden in
     * die Log-Datei eingetragen.
     * 
     * @param argumentList
     *            siehe
     *            sys.funclib.application.StandardApplication#parseArguments
     ...
     * durchführt.<br>
     * Entsprechend dem Argument -layer wird die entsprechende Methode
     * aufgerufen und danach die Log-Datei geschlossen.<br>
     * 
     * @param connection
     *            siehe
