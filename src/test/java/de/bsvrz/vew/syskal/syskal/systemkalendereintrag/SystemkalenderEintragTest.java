...
public class SystemkalenderEintragTest {
	...
	public void berechneZustandsWechselVonBisTest() throws Exception {
		...
		assertTrue("Test 15", zustandsWechsel.get(offset).getZeitPunkt().equals(LocalDateTime.of(2008, 1, 15, 15, 30, 00))
				&& zustandsWechsel.get(offset).isWirdGueltig());
		offset++;
		...
		assertTrue("Test 19", zustandsWechsel.get(offset).getZeitPunkt().equals(LocalDateTime.of(2008, 1, 16, 15, 30, 00))
				&& zustandsWechsel.get(offset).isWirdGueltig());
		offset++;
