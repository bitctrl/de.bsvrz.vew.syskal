...
public class ZeitBereichsEintragTest {
	...
	public void testeGueltigkeit() {
		...
		assertEquals(LocalDateTime.of(2008, 1, 30, 11, 59, 59).plusNanos(999000), gueltigKeit.getBeginn().getZeitPunkt());
	...
	public void testeZustandswechsel() {
		...
		List<ZustandsWechsel> zustandsWechselListe = bereich4.getZustandsWechselImBereich(start, LocalDateTime.of(2008, 2, 1, 11, 11));
		...
		for (int index = 0; index < zustandsWechselListe.size(); index++) {
			...
			case 1:
				...
				break;
			case 2:
				assertEquals(LocalDateTime.of(2008, 1, 30, 17, 59, 59).plusNanos(999000), zustandsWechsel.getZeitPunkt());
				assertFalse(zustandsWechsel.isWirdGueltig());
				break;
			case 3:
				...
				break;
			case 4:
				assertEquals(LocalDateTime.of(2008, 1, 31, 11, 59, 59).plusNanos(999000), zustandsWechsel.getZeitPunkt());
				assertFalse(zustandsWechsel.isWirdGueltig());
				break;
			case 5:
				...
				break;
			case 6:
				assertEquals(LocalDateTime.of(2017, 1, 31, 17, 59, 59).plusNanos(999000), zustandsWechsel.getZeitPunkt());
				assertFalse(zustandsWechsel.isWirdGueltig());
				break;
			case 7:
